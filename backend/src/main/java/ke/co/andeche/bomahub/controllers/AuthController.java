...
import ke.co.andeche.bomahub.dto.UserRegistrationRequest;
...
//    }
    ...
    public ResponseEntity<?> register(@RequestBody UserRegistrationRequest request) {
        ...
        // Validate organization verification code
        Optional<Organization> orgOptional = organizationRepository.findByVerificationCode(request.getVerificationCode());
        if (orgOptional.isEmpty()) {
            Map<String, String> error = new HashMap<>();
            error.put("error", "Invalid organization verification code");
        ...
        user.setPassword(request.getPassword()); // Make sure password is encoded
