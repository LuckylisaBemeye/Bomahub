  ...
  const [selectedPropertyId, setSelectedPropertyId] = useState<number | null>(null);  useEffect(() => {
    const fetchTenants = async () => {
      ...
      try {
        ...
        // Backend should filter by user's organization automatically
        ...
        tenanciesData.forEach(tenancy => {
          ...
          const firstName = tenancy.tenant.firstName || '';
          const lastName = tenancy.tenant.lastName || '';
          ...
          group.units.push({
            ...
            propertyId: tenancy.unit.property?.id || 0,
            propertyName: tenancy.unit.property?.name || 'Unknown Property',
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {groupedTenants.map((tenant) => (
                  <tr key={tenant.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        {tenant.units.map((unit) => (
                          <div key={unit.unitId} className="flex flex-col">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-xs">Ksh {unit.rentAmount}/mo</span>
                            </div>
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div className="font-medium">Ksh {tenant.totalRent}/mo</div>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex flex-col items-end space-y-2">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-semibold text-gray-900">Ksh {tenant.totalRent}/mo</div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm font-medium text-gray-900">Ksh{unit.rentAmount}/mo</span>
                            </div>
                            <div className="mt-1">
                              <Link 
